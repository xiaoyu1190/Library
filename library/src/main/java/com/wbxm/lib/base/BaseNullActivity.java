...
public abstract class BaseNullActivity extends FragmentActivity implements IBaseView{
    ...
    public void showMsg(final String msg) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                ToastUtil.ToastMessage(BaseNullActivity.this, msg);
            }
        });
    }
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (progressDialog == null) {
                    progressDialog = new LoadingDialog(BaseNullActivity.this);
                }
